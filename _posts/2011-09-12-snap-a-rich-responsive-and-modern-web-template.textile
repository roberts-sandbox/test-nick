...
<img src="/img/articles/snap-1024x574.png" width="100%" /><br />


The sample above displays a style of website layout design that responds to the device by snapping into various views depending the device’s screen size, providing the user with a more seamless experience from mobile to desktop.
...
View the source for the project here. View the demo here.