...
<h2>A brand is not a logo, a visual style guide, a color palette, or a set of icons. It’s a set of feelings or impressions people have about a company and its products or services. A solid brand experience is achieved using a set of messages that exist in time and space.</h2>
