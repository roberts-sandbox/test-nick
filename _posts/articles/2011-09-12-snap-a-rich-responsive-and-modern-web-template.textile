---
  ...
  permalink: articles/2011/09/12/snap-a-rich-responsive-and-modern-web-template
  categories: [articles]
---
...
<em>The <a href="https://github.com/nickcottrell/Snap">sample above</a> displays a style of website layout design that responds to the device by snapping into various views depending the device’s screen size, providing the user with a more seamless experience from mobile to desktop.</em>
